  ...
  return (
    <div className="page settings-page">
      ...
      <section className="card setup-card">
        <h2>Quick updates</h2>
        <p className="hint">
          Choose the shortcuts and icons on the Updates drawer. You can also use{" "}
          {partnerDisplayName(me.partnerName)}&apos;s list.
        </p>
        <Link to="/settings/quick-updates" className="btn secondary">
          Edit quick updates
        </Link>
      </section>
